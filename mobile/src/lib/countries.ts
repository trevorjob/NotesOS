...
// Generated country table for the phone-number country picker. Names are baked in
// at build time (Node Intl.DisplayNames) because Hermes has no Intl.DisplayNames at
// runtime. Regenerate with the script in docs/mobile-integration-plan.md if the
// libphonenumber-js metadata changes. Sorted by English name.
...
export const COUNTRIES: Country[] = [
  ...
  { code: 'MO', name: "Macao SAR China", dialCode: '853', flag: '🇲🇴' },
  ...
  { code: 'PS', name: "Palestinian Territories", dialCode: '970', flag: '🇵🇸' },
  ...
  { code: 'SH', name: "St. Helena", dialCode: '290', flag: '🇸🇭' },
  { code: 'KN', name: "St. Kitts & Nevis", dialCode: '1', flag: '🇰🇳' },
  { code: 'LC', name: "St. Lucia", dialCode: '1', flag: '🇱🇨' },
  { code: 'MF', name: "St. Martin", dialCode: '590', flag: '🇲🇫' },
  { code: 'PM', name: "St. Pierre & Miquelon", dialCode: '508', flag: '🇵🇲' },
  { code: 'VC', name: "St. Vincent & Grenadines", dialCode: '1', flag: '🇻🇨' },
  ...
  { code: 'TC', name: "Turks & Caicos Islands", dialCode: '1', flag: '🇹🇨' },
...
const BY_CODE: Record<string, Country> = Object.fromEntries(COUNTRIES.map((ctry) => [ctry.code, ctry]));

/** Look up a country by its ISO code (e.g. 'NG'). */
